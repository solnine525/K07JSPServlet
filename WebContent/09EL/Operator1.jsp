...
<body>
	...
	<!-- 할당과 동시에 출력하지 않으려면 뒷부분에 ;''와 같이 처리해야 한다.
	...
	EL에서는 자동형변환이 되므로 실수의 결과도 나올 수 있다.
	 -->
	...
	num1 % num2 : ${num1 % num2 }<br/>
	num1 mod num2 : ${num1 mod num2 }<br/><!-- 나머지 연산을 위한 mod연산자 -->
	
	<h3>+연산자는 덧셈만 가능</h3>
	<!-- 
	EL에서는 +연산자는 덧셈만 가능하고 문자열 연결은 불가능하다.
	만약 문자열을 통한 연결을 하고 싶다면 별도의 EL을 사용한다.
	 -->
	num1+"34" : ${num1+"34" } <br/>
