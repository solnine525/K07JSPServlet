...
<body>
	...
	<!--  
	기본값이거나 true 일 때는 HTML이 해석되지 않고, 태그까지
	...
	<!--  
	-out태그에 value 속성의 값이 null일 때는 default 속성에
	지정된 값이 출력된다.
	-단, 값이 빈 문자열("")인 경우는 값이 있는 것으로 간주되어
	default 속성에 지정한 값이 출력되지 않는다.
	-->
	<h3>default 속성</h3>
	<h4> 값이 빈 문자열 : 값이 있는 경우에 해당</h4>
	출력 : <c:out value="" default="값이 빈 문자열" />
	
	<h4>값이 null 인 경우 : 값이 없는 경우에 해당</h4>
	...
	<a href="<c:url value="/08Board/List.jsp?pageNum=" /><c:out value="${param.pageNum }" default="1" />" >회원제 게시판 리스트 바로가기</a>
