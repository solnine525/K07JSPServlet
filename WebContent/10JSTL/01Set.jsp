...
<body>
	...
	<!-- 
	EL로 영역의 속성을 읽어올 때에는 xxScope를 생략하면 가장 좁은
	영역인 page영역을 일겅오게 되므로, 속성명이 중복되지 않는다면
	내장객체를 생략할 수 있다.
	 -->
	<h3>EL로 출력</h3>
	...
	<!--  
	2. 생성된 변수의 멤버값을 지정함. setter를 통한 값 설정
	-->		
	...
	<h4>1단계 : set 태그로 리스트계열 컬렉션 설정</h4>
	...
	<ul>
		...
		<li>비밀번호: ${requestScope.list[0].pass }</li>
	...
	<!-- 
	Map계열의 컬렉션은 ket를 통해 value에 접근한다. key를 통한
