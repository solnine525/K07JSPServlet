...
저장됙, 사용시에는 각 객체로 형변환 후 사용하면 된다.
차후 EL, JSTL에서도 주로 해당 영역을 사용하게 된다. 
*/
...
/*
개발자가 정의한 DTO 객체를 초기화한 후 page영역에 저장한다.
*/
MemberDTO member1 = new MemberDTO();
member1.setId("KOSMO");
member1.setName("한국소프트에어인재개발원");
...
<body>
	...
	<%
	/*
	page영역에 저장된 속성을 윍어온다. 영역에 저장될 때는 
	Object형으로 자동형변환 되므로, 읽어올 때도 Object형으로
	가져오게 된다.
	*/
	...
	/*
	DTO객체에 저장된 각 속성들을 getter를 통해 문자열로 가져온 후 
	...
	*/
	...
	<%--
		외부파일을 include 하는 것은 해당 파일을 원본 그대로
		현재 문서에 포함시킨 후 컴파일 되므로, include 지시어를
